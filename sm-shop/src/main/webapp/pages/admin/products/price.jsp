                ...
                <form:form method="POST" modelAttribute="price" action="${saveProductPrice}">
                    ...
                    <c:forEach items="${price.descriptions}" var="description" varStatus="counter">
                        ...
                        <div class="control-group">
                            ...
                            <label><s:message code="label.product.price.appender" text="Product price appender"/>
                                (<c:out value="${description.language.code}"/>)</label>
                            <div class="controls">
                                <form:input cssClass="input-large highlight" id="priceAppender${counter.index}"
                                            path="descriptions[${counter.index}].priceAppender"/>
                                <span class="help-inline"><form:errors
                                        path="descriptions[${counter.index}].priceAppender" cssClass="error"/></span>
                            </div>
                        </div>
