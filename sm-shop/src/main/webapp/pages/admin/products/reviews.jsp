    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="catalogue-section">
            ...
            <div class="sm-ui-component">
                ...
                <c:set value="/admin/products/reviews/paging.html?productId=${product.id}" var="pagingUrl"
                       scope="request"/>
                <c:set value="/admin/products/reviews/remove.html" var="removeUrl" scope="request"/>
                <c:set value="/admin/products/reviews/paging.html?productId=${product.id}" var="refreshUrl"
                       scope="request"/>
