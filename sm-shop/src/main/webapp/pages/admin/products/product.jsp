                ...
                <form:form method="POST" enctype="multipart/form-data" modelAttribute="product" action="${productSave}">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <span class="help-inline"><s:message code="label.generic.alphanumeric" text="Alphanumeric"/><form:errors
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <form:select items="${manufacturers}" itemValue="id" itemLabel="descriptions[0].name"
                    ...
                    <c:forEach items="${product.descriptions}" var="description" varStatus="counter">
                        ...
                        <div class="control-group">
                            <label class="required"><s:message code="label.sefurl" text="Search engine friendly url"/> (<c:out
                                    value="${description.language.code}"/>)</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <span class="help-inline"><form:errors
                                        path="descriptions[${counter.index}].productHighlight" cssClass="error"/></span>
                            </div>
                        ...
                        <div class="control-group">
                            <label class="required"><s:message code="label.product.title" text="Product title"/> (<c:out
                                    value="${description.language.code}"/>)</label>
                            <div class="controls">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <span id="help-price" class="help-inline"><form:errors path="productPrice"
                                                                                   cssClass="error"/></span>
                        </div>
                    </div>
