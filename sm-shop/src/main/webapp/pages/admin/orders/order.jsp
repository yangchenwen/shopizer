            ...
            <div class="sm-ui-component">
                        ...
                        <address>
                            ...
                            <address>
                                ...
                                <div class="controls">
                                    ...
                                    <span class="help-inline"><form:errors path="order.billing.address"
                                                                           cssClass="error"/></span>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <form:select id="billingZoneList" cssClass="billing-zone-list"
                                                     path="order.billing.zone.code"/>
                                        <form:input class="input-large highlight" id="billingZoneText" maxlength="100"
                                                    name="billingZoneText" path="order.billing.state"/>
                                        <span class="help-inline"><form:errors path="order.billing.zone.code"
                                                                               cssClass="error"/></span>
                                    </div>
                                </div>
                                ...
                                <div class="controls">
                                    <form:input id="billingPostalCode" cssClass="input-large highlight"
                                                path="order.billing.postalCode"/>
                                    <span class="help-inline"><form:errors path="order.billing.postalCode"
                                                                           cssClass="error"/></span>
                                </div>
                                ...
                                <div class="controls">
                                    ...
                                    <span class="help-inline"><form:errors path="order.billing.telephone"
                                                                           cssClass="error"/></span>
                                </div>
                            </address>
                            ...
                            <div class="controls">
                                ...
                                <span class="help-inline"><form:errors path="order.customerEmailAddress"
                                                                       cssClass="error"/></span>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <form:input class="input-large highlight" id="shippingZoneText" maxlength="100"
                                                name="shippingZoneText" path="order.delivery.state"/>
                                    <span class="help-inline"><form:errors path="order.delivery.zone.code"
                                                                           cssClass="error"/></span>
                                </div>
                            </div>
                ...
                <div class="span8">
                    ...
                    <label><s:message code="label.customer.order.agreement.title" text="Terms and conditions"/>:
                        <strong><c:out value="${order.order.customerAgreement}"/></strong></label>
                    ...
                    <c:if test="${order.order.shippingModuleCode!=null}">
                        ...
                        <div class="controls">
                            <strong><c:out value="${order.order.shippingModuleCode}"/></strong><form:hidden
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <c:forEach items="${order.order.orderProducts}" var="orderProduct" varStatus="counter">
                            ...
                            <tr>
                                ...
                                <td><strong><sm:monetary value="${orderProduct.oneTimeCharge}"
                                                         currency="${order.order.currency}"/></strong></td>
                                <td><strong><sm:monetary value="${total}" currency="${order.order.currency}"/></strong>
                                </td>
                            </tr>
                        ...
                        <c:forEach items="${order.order.orderTotal}" var="orderTotal" varStatus="counter">
                            <tr class="subt">
                                ...
                                <td><strong>
                                    <c:if test="${orderTotal.orderTotalCode=='refund'}"><font color="red"></c:if>
                                    <sm:monetary value="${orderTotal.value}" currency="${order.order.currency}"/>
