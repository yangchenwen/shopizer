...
<div class="tabbable">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="taxrates-section">
            <a href="<c:url value="/admin/tax/taxrates/list.html"/>"><s:message code="label.generic.back"
                                                                                text="Back"/></a><br/><br/>
                ...
                <form:form method="POST" modelAttribute="taxRate" action="${saveTaxRate}">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input type="text" class="input-large" value="${taxRate.stateProvince}" id="stateProvince"
                                   name="stateProvince"/>
                    ...
                    <c:forEach items="${taxRate.descriptions}" var="description" varStatus="counter">
                        ...
                        <div class="control-group">
                            ...
                            <label class="required"><s:message code="menu.taxrates.name" text="Tax name"/> (<c:out
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <span id="help-rateText" class="help-inline"><form:errors path="rateText"
                                                                                      cssClass="error"/></span>
                        </div>
                    </div>
