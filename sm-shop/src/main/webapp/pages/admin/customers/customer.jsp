    ...
    <c:if test="${customer.id!=null && customer.id>0}">
        <div class="btn-group" style="z-index:400000;">
            ...
            <ul class="dropdown-menu">
                <li><a id="${customer.id}" href="#resetPassword"><s:message code="button.label.resetpassword"
                                                                            text="Reset password"/></a></li>
                <li><a id="${customer.id}" href="#setCredentials"><s:message code="button.label.setcredentials"
    ...
    <form:form method="POST" modelAttribute="customer" action="${saveCustomer}">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <form:select class="input-large" items="${languages}" itemValue="id" itemLabel="code"
        ...
        <c:if test="${fn:length(groups)>0}">
            <div class="control-group">
                ...
                <div class="controls">
                    <form:checkboxes cssClass="highlight" items="${groups}" itemValue="id" itemLabel="groupName"
