            ...
            <div class="sm-ui-component">
                ...
                <form:form method="POST" modelAttribute="user" action="${userSave}">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <form:select cssClass="" items="${stores}" itemValue="id" itemLabel="code"
                                         path="merchantStore.id"/>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <form:select cssClass="" items="${languages}" itemValue="id" itemLabel="code"
                    ...
                    <sec:authorize access="hasRole('ADMIN') and fullyAuthenticated">
                        <div class="control-group">
                            <label><strong></strong><s:message code="label.entity.active" text="Active"/></strong>
                            </label>
                            <div class="controls">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <form:select cssClass="" items="${questions}" itemValue="label" itemLabel="label"
                                         path="question1"/>
