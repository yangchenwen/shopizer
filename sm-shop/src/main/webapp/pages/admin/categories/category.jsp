            ...
            <div class="sm-ui-component">
                <h3>
                    <c:choose>
                        <c:when test="${category.category.id!=null && category.category.id>0}">
                            <s:message code="label.category.editcategory" text="Edit category"/> <c:out
                ...
                <form:form method="POST" modelAttribute="category" action="${categorySave}">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <form:input cssClass="input-large highlight" id="code" path="category.code"
                    ...
                    <c:forEach items="${category.descriptions}" var="description" varStatus="counter">
                        <div class="control-group">
                            <label><s:message code="label.productedit.categoryname" text="Category name"/> (<c:out
                        ...
                        <div class="control-group">
                            <label><s:message code="label.category.highlight" text="Category highlight"/> (<c:out
                                    value="${description.language.code}"/>)</label>
                            <div class="controls">
                                <form:input cssClass="input-large" id="categoryHighlight${counter.index}"
                        ...
                        <div class="control-group">
                            <label><s:message code="label.category.categorydescription" text="Category description"/>
                        ...
                        <div class="control-group">
                            <label><s:message code="label.category.title" text="Metatag title"/> (<c:out
                                    value="${description.language.code}"/>)</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <label><s:message code="label.metatags.keywords" text="Metatag keywords"/> (<c:out
                                    value="${description.language.code}"/>)</label>
                            <div class="controls">
                                <form:input path="descriptions[${counter.index}].metatagKeywords"/>
                                <span class="help-inline"><form:errors
                                        path="descriptions[${counter.index}].metatagKeywords" cssClass="error"/></span>
                            </div>
                        </div>
                        <div class="control-group">
                            <label><s:message code="label.metatags.description" text="Metatag description"/> (<c:out
                                    value="${description.language.code}"/>)</label>
                            <div class="controls">
