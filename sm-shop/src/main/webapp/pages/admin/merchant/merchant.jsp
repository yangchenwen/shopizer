    ...
    <form:form method="POST" modelAttribute="store" action="${merchant}">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <input type="text" class="input-large highlight" id="storestateprovince" name="storestateprovince"
                       value="${store.storestateprovince}"/>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <form:checkboxes cssClass="highlight" items="${languages}" itemValue="id" itemLabel="code"
                                 path="languages"/>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input id="dateBusinessSince" name="dateBusinessSince" value="${store.dateBusinessSince}" class="small"
                       type="text"
