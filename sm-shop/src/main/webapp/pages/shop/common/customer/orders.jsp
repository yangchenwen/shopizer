                            ...
                            <table class="table table-striped">
                                ...
                                <c:forEach items="${customerOrders.orders}" var="order" varStatus="orderStatus">
                                    <tr><!-- item -->
                                        ...
                                        <td><sm:monetary
                                                value="${order.total.value}"/>&nbsp;<small>(${fn:length(order.products)}
                                            <c:choose><c:when test="${fn:length(order.products)==1}"><s:message
                                                    code="label.generic.item"
                                                    text="item"/></c:when><c:otherwise><s:message
                                                    code="label.generic.items"
                                                    text="items"/></c:otherwise></c:choose>)</small></td>
