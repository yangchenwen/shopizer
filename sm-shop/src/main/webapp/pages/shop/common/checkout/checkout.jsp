                    ...
                    <div class="span8 col-md-8 no-padding-left">
                        ...
                        <div id="shippingBox" class="checkout-box">
											<span class="box-title">
												<p class="p-title"><s:message code="label.customer.billinginformation"
                            ...
                            <div class="row-fluid common-row row">
                                <div class="span8 col-md-8">
                                    <div class="control-group form-group">
                                        ...
                                        <div class="controls">
                                            <form:select cssClass="zone-list form-control form-control-lg"
                                            ...
                                            <form:input class="input-large required form-control form-control-lg"
                            ...
                            <div class="row-fluid common-row row">
                                <div class="span4 col-md-4">
                                    <div class="control-group form-group">
                                        ...
                                        <div class="controls">
                                            <form:select cssClass="billing-country-list form-control form-control-lg"
                                ...
                                <div class="row-fluid common-row row">
                                    <div class="span8 col-md-8">
                                        <div class="control-group form-group">
                                            ...
                                            <div class="controls">
                                                <form:select cssClass="zone-list form-control" id="deliveryStateList"
                        ...
                        <c:if test="${shippingQuote!=null}">
                            ...
                            <div class="checkout-box">
										<span class="box-title">
												<p class="p-title"><s:message code="label.shipping.fees"
                                        ...
                                        <div id="shippingSection" class="control-group">
                                            ...
                                            <div id="shippingOptions" class="controls">
                                                <c:if test="${shippingQuote.shippingReturnCode=='NO_POSTAL_CODE'}">
                                                    <strong>
                                                        <s:message code="label.shipping.nopostalcode"
                                                ...
                                                <c:forEach items="${shippingQuote.shippingOptions}" var="option"
                                                    ...
                                                    <label class="radio">
                                                        ...
                                                        <s:message code="module.shipping.${option.shippingModuleCode}"
                        ...
                        <c:if test="${fn:length(paymentMethods)>0}">
                            ...
                            <div class="checkout-box">
										<span class="box-title">
											<p class="p-title"><s:message code="label.payment.module.title"
                                            ...
                                            <div class="payment-tab tab-pane <c:choose><c:when test="${order.paymentMethodType!=null && order.paymentMethodType==paymentMethod.paymentType}">active</c:when><c:otherwise><c:if test="${order.paymentMethodType==null && paymentMethod.defaultSelected==true}">active</c:if></c:otherwise></c:choose>"
                                                ...
                                                <c:choose>
                                                    <c:when test="${order.paymentMethodType!=null && order.paymentMethodType==paymentMethod.paymentType}">
                                                        <c:set var="paymentModule" value="${order.paymentMethodType}"
                                                               scope="request"/>
                                                    </c:when>
                                                    <c:otherwise>
                                                ...
                                                <c:set var="selectedPaymentMethod" value="${order.paymentMethodType}"
                                                       scope="request"/>
                    ...
                    <div class="span4 col-md-4 no-padding">
                        ...
                        <div class="checkout-box">
											<span id="summaryBox" class="box-title">
												<p class="p-title"><s:message code="label.order.summary"
