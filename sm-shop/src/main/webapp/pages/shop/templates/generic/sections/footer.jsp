                            ...
                            <ul class="usefull-link">
                                ...
                                <c:if test="${requestScope.CONFIGS['displayCustomerSection'] == true}">
                                    ...
                                    <sec:authorize access="!hasRole('AUTH_CUSTOMER') and !fullyAuthenticated">
                                        ...
                                        <li><a href="<c:url value="/shop/customer/customLogon.html"/>"><s:message
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 mar_b-30">
                <div class="copyright text-left">
                    <p><sm:storeCopy/>&nbsp;-&nbsp;<s:message code="label.generic.providedby"/> <a
                            href="http://www.shopizer.com" class="footer-href" target="_blank">Shopizer</a></p>
                </div>
            </div>
                ...
                <c:if test="${requestScope.CONFIGS['allowPurchaseItems'] == true}">
                    <div class="copyright-img text-right">
                        <img src="/resources/img/payment/icons/MasterCard.png" width="50" alt=""/>&nbsp;<img
                            ...
                            src="/resources/img/payment/icons/AmericanExpress.png" width="50" alt=""/>&nbsp;<img
