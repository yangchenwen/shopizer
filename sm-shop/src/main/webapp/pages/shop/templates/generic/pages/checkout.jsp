                ...
                <div class="coupon-accordion">
                    ...
                    <sec:authorize access="!hasRole('AUTH_CUSTOMER') and !fullyAuthenticated">
                        <p class="muted common-row"><a
                                ...
                                text="Logon or signup to simplify the online purchase process!"/></a></p>
                    </sec:authorize>
                </div>
            </div>
        </div>
...
<div class="checkout-area pb-50">
    <div class="container">
        <div class="row">
            ...
            <form:form autocomplete="off" id="checkoutForm" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="checkout-form-list">
                                    <label><s:message code="label.generic.firstname" text="First Name"/><span
                            ...
                            <div class="col-md-6">
                                <div class="checkout-form-list">
                                    <label><s:message code="label.generic.lastname" text="Last Name"/><span
                                            class="required">*</span></label>
                                    <s:message code="NotEmpty.customer.lastName" text="Last name is required"
                                               var="msgLastName"/>
                                    <form:input id="customer.lastName" cssClass="required" maxlength="32"
                                                path="customer.billing.lastName" title="${msgLastName}"/>
                            ...
                            <div class="col-md-12">
                                <div class="checkout-form-list">
                                    <label><s:message code="label.generic.streetaddress" text="Street address"/> <span
                                            class="required">*</span></label>
                                    <s:message code="NotEmpty.customer.billing.address" text="Address is required"
                                               var="msgAddress"/>
                            ...
                            <div class="col-md-12">
                                <div class="country-select">
                                    <label><s:message code="label.generic.country" text="Country"/> <span
                                            class="required">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="checkout-form-list zone-select">
                                    <label><s:message code="label.generic.stateprovince" text="State / Province"/> <span
                                            class="required">*</span></label>
                                    ...
                                    <form:input class="${cssClass}" id="billingStateProvince" maxlength="100"
                                                name="billingStateProvince" path="customer.billing.stateProvince"
                            ...
                            <div class="col-md-6">
                                <div class="checkout-form-list">
                                    <label><s:message code="label.generic.postalcode" text="Postal code"/> <span
                                            class="required">*</span></label>
                                    <s:message code="NotEmpty.customer.billing.postalCode"
                                               text="Postal code is required" var="msgPostalCode"/>
                                    <form:input id="billingPostalCode" cssClass="${cssClass} billing-postalCode"
                            ...
                            <div class="col-md-6">
                                <div class="checkout-form-list">
                                    <label><s:message code="label.generic.email" text="Email address"/> <span
                                            class="required">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="checkout-form-list">
                                    <label><s:message code="label.generic.phone" text="Phone number"/> <span
                                            class="required">*</span></label>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div id="cbox_info" class="checkout-form-list create-account">
                                        ...
                                        <label><s:message code="label.customer.accountpassword"
                                                ...
                                                class="required">*</span></label>
                                        <form:input id="customer.password" cssClass="required" path="customer.password"
                                                    title="${msgPassword}"/>
                                    </div>
                                </div>
                            </sec:authorize>
                        ...
                        <c:if test="${shippingQuote!=null}">
                            <div class="different-address">
                                <div class="ship-different-title">
                                    <h3>
                                        <label><s:message code="label.customer.shipping.shipdifferentaddress"
                                ...
                                <div id="ship-box-info" class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="checkout-form-list">
                                            ...
                                            <form:input id="customer.delivery.address" cssClass="required"
                                                        path="customer.delivery.address" title="${msgShippingAddress}"/>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="checkout-form-list">
                                            <label><s:message code="label.customer.shipping.city" text="Shipping city"/>
                                                <span class="required">*</span></label>
                                            <s:message code="NotEmpty.customer.shipping.city"
                                                       text="Shipping city should not be empty" var="msgShippingCity"/>
                                    ...
                                    <div class="col-md-6">
                                        <div class="checkout-form-list zone-select">
                                            ...
                                            <form:input class="required" id="deliveryStateProvince" maxlength="100"
                                    ...
                                    <div class="col-md-6">
                                        <div class="checkout-form-list">
                                            ...
                                            <form:input id="deliveryPostalCode" cssClass="required delivery-postalCode"
                                ...
                                <div class="order-notes">
                                    <div class="checkout-form-list">
                                        ...
                                        <s:message code="label.order.notes.eg" text="Notes for the order or delivery"
                                                   var="msgNotes"/>
                                        <form:textarea id="comments" cols="30" rows="10" path="comments"
                                                       placeholder="${msgNotes}"/>
                                    </div>
                                </div>
                            </div>
                        </c:if>
                                ...
                                <c:forEach items="${cart.shoppingCartItems}" var="shoppingCartItem">
                                    <tr class="cart_item">
                                        <td class="product-name">
                                                ${shoppingCartItem.name} <strong class="product-quantity">
                                        ...
                                        <td id="shippingSection" style="border:none !important;">
                                            <c:choose>
                                                <c:when test="${fn:length(shippingQuote.shippingOptions)>0}">
                                                    ...
                                                    <table id="shippingOptions">
                                                        <c:forEach items="${shippingQuote.shippingOptions}" var="option"
                                                                   varStatus="status">
                                                            <tr>
                                                                <td style="border: none !important;">
                                                                    <input type="radio"
                            ...
                            <div class="payment-method">
                                ...
                                <div class="v-margin20">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <input type="hidden" id="paymentMethodType" name="paymentMethodType"
