        ...
        <li class="click_menu"><a href="#"><s:message code="label.generic.welcome" text="Welcome"/>
            ...
            <ul class="click_menu_show">
                <li><a href="#" onClick="javascript:location.href='<c:url value="/shop/customer/dashboard.html" />';"
                       href="#"><s:message code="label.customer.myaccount" text="My account"/></a></li>
...
<script type="text/html" id="customerNotLoggedInAccountTemplate">
    <ul>
        <li class="click_menu"><a href="#"><s:message code="label.customer.myaccount" text="My Account"/><i
...
<script type="text/html" id="miniCartTemplate">
    ...
    <li class="checkout-bg">
        <a href="#" onclick="viewShoppingCartPage();"><s:message code="label.checkout" text="Checkout"/><i
                class="fa fa-angle-right"></i></a>
    </li>
    {{/code}}
    {{^code}}
    <h4 style="text-align: center;color:#666666;margin-top:10px;margin-bottom:10px;"><s:message code="label.emptycart"
            ...
            <div class="row">
                <div class="col-lg-9 col-md-8 col-sm-8">
                    ...
                    <c:if test="${requestScope.CONFIGS['displayContactUs']==true}">
                        ...
                        <a href="<c:url value="/shop/store/contactus.html"/>"><s:message code="label.customer.contactus"
                                                                                         text="Contact us"/></a>
                        </button>
                    </c:if>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-9 col-xs-12">
                    ...
                    <c:if test="${requestScope.CONFIGS['displaySearchBox'] == true}">
                        ...
                        <div class="input-group menu-search-box">
                            <input type="text" class="form-control typeahead" type="search" name="q" id="searchField"
                                   placeholder="<s:message code="label.generic.search" text="Search"/>" value=""/>
                            <span class="input-group-btn">
        							<button class="btn btn-default searchButton" type="button"><s:message
