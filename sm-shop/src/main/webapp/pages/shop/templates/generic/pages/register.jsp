                ...
                <div class="login-form">
                    <form:form method="post" action="${register_url}" id="registrationForm" modelAttribute="customer">
                        ...
                        <div class="form-group login-page">
                            <label for="firstName"><s:message code="label.generic.firstname" text="First Name"/>
                                <span>*</span></label>
                        ...
                        <div class="form-group login-page">
                            <label for="lastName"><s:message code="label.generic.lastname" text="Last Name"/>
                                <span>*</span></label>
                        ...
                        <div class="form-group login-page">
                            <label for="stateProvince"><s:message code="label.generic.stateprovince"
                                                                  text="State / Province"/> <span>*</span></label>
                            ...
                            <form:input path="billing.stateProvince"
                                        cssClass="span8 required form-control form-control-md" id="hidden_zones"
                        ...
                        <div class="form-group login-page">
                            <label for="email"><s:message code="label.generic.email" text="Email address"/>
                                <span>*</span></label>
                        ...
                        <div class="form-group login-page">
                            <label for="repeatPassword"><s:message code="label.generic.repeatpassword"
                                                                   text="Repeat password"/> <span>*</span></label>
                        ...
                        <button type="submit" class="btn btn-default login-btn"><s:message
                                code="label.register.createaccount" text="Create an account"/></button>
                    </form:form>
                </div>
            </div>
