...
<script type="text/html" id="customerLoggedInAccountTemplate">
    <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="false"> <i
            class="fa fa-user mr-5"></i><span class="hidden-xs"><s:message code="label.generic.welcome" text="Welcome"/>&nbsp;<span>{{firstName}}</span><i
            class="fa fa-angle-down ml-5"></i></span> </a>
    <ul class="dropdown-menu w-150" role="menu">
        <li><a href="#" onClick="javascript:location.href='<c:url value="/shop/customer/dashboard.html" />';"
               href="#"><s:message code="label.customer.myaccount" text="My account"/></a></a>
        </li>
        <li><a href="#" onClick="javascript:location.href='<c:url value="/shop/customer/logout" />';"
...
<script type="text/html" id="customerNotLoggedInAccountTemplate">
    <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="false"> <i
            class="fa fa-user mr-5"></i><span class="hidden-xs"><s:message code="label.customer.myaccount"
                                                                           text="My Account"/><i
            class="fa fa-angle-down ml-5"></i></span> </a>
    <ul class="dropdown-menu w-150" role="menu">
                    ...
                    <div class="product-details">
                        <div class="close-icon">
                            <button productid="{{productId}}" class="close removeProductIcon"
                                    onclick="removeItemFromMinicart('{{id}}')"><i class="fa fa-times-circle"></i></a>
                        </div>
                        <p class="product-name"><a href="#">{{name}}</a></p> <strong>{{quantity}}</strong> x <span
    ...
    <li>
        <div class="cart-footer">
            ...
            <a href="#" onclick="viewShoppingCartPage();" class="pull-right"><i
                    class="fa fa-shopping-basket mr-5"></i><s:message code="label.checkout" text="Checkout"/></a>
        </div>
    </li>
    {{/code}}
    {{^code}}
    <li>
        <div class="cart-items">
            <ol class="items">
                ...
                <h5 style="text-align: center;color:#666666;margin-top:10px;margin-bottom:10px;"><s:message
                        code="label.emptycart" text="Your Shopping cart is empty"/></h5>
    ...
    <div class="container">
        <c:if test="${requestScope.CONFIGS['displayContactUs']==true}">
            <ul class="list-inline pull-left hidden-sm hidden-xs">
                <li><span class="text-primary"><s:message code="label.store.question" text="Have a question?"/></span>&nbsp;&nbsp;&nbsp;<abbr
                        title="Email"><s:message code="label.generic.email" text="Email"/></abbr>: <span
                        itemprop="email"><a class="store-name" style="color:#000;"
                        ...
                        title="Phone"><s:message code="label.generic.phone" text="Phone"/></abbr>: <span
                        ...
                        value="${requestScope.MERCHANT_STORE.storephone}"/></strong></a></span></li>
            ...
            <c:if test="${fn:length(requestScope.MERCHANT_STORE.languages) > 1}">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                       data-close-others="false"> <img src="" class="mr-5" alt=""> <span class="hidden-xs"> <s:message
                            code="lang.${requestScope.LANGUAGE.code}" text="${requestScope.LANGUAGE.code}"/> <i
                            class="fa fa-angle-down ml-5"></i></span> </a>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                       data-close-others="false"> <i class="fa fa-shopping-basket mr-5"></i> <span class="hidden-xs">
                                <s:message code="label.cart" text="Shopping cart"/><sup class="text-primary">(<span
                            id="miniCartSummary"></span>)</sup>
                ...
                <c:if test="${requestScope.CONFIGS['displaySearchBox'] == true}">
                    <form>
                        <div class="row grid-space-1">
                            <div class="col-sm-9">
                                <input type="text" name="q" id="searchField" class="form-control input-lg typeahead"
                                       placeholder="<s:message code="label.generic.search" text="Search"/>" value="">
                            </div>
                            <!-- end col -->
                            <div class="col-sm-3">
                                <input type="submit" class="btn btn-default btn-block btn-lg searchButton"
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse navbar-1" style="margin-top: 5px;">
            <ul class="nav navbar-nav">
                <li><a href="<c:url value="/shop/"/>" class="dropdown-toggle"><s:message code="menu.home"
                                                                                         text="Home"/></a></li>
                <!-- Categories -->
                <!-- mega menu style -->
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                       data-close-others="false"><s:message code="menu.catalogue-products" text="Products"/> <i
