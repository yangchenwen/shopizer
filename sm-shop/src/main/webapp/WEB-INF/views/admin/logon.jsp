...
<div id="tabbable" class="sm">
    ...
    <div id=logon>
        ...
        <div id="login-box">
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <label class="checkbox">
                                    ...
                                    <br/>
                                    <a href="#" id="changePassword"><s:message code="label.logonform.forgotpassword"
            ...
            <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" class="modal hide fade"
                 id="getPassword" style="display: none;">
    ...
    <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" class="modal hide fade"
         id="getSecurityQtn" style="display: none;">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"
                    aria-hidden="true">
                ×
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" class="modal hide fade"
     id="finalWindow" style="display: none;">
